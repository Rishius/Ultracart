...
<html>
  ...
  <form method='POST' action='./add_items.php'>
    <table>
      ...
      <tbody>
        <tr><td>1.</td><td><input type='text' name='item[]' size='20' /></td><td><input type='text' name='quantity[]' size='5' /></td></tr>
        <tr><td>2.</td><td><input type='text' name='item[]' size='20' /></td><td><input type='text' name='quantity[]' size='5' /></td></tr>
        <tr><td>3.</td><td><input type='text' name='item[]' size='20' /></td><td><input type='text' name='quantity[]' size='5' /></td></tr>
        <tr><td>4.</td><td><input type='text' name='item[]' size='20' /></td><td><input type='text' name='quantity[]' size='5' /></td></tr>
        <tr><td>5.</td><td><input type='text' name='item[]' size='20' /></td><td><input type='text' name='quantity[]' size='5' /></td></tr>
      </tbody>
